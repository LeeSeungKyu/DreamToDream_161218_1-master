...
public class StartCharity extends FragmentActivity {
            ...
            if (!miBand.isConnected()) {
                miBand.connect(new ActionCallback() {
                    ...
                    public void onSuccess(Object data) {
                        ...
                        ArrayList<ActivityData> allActivities2 = ActivitySQLite.getInstance(StartCharity.this)
                                .getAllActivities();

                        Log.i(TAG, "1***"+String.valueOf(allActivities.size()));
                        Log.i(TAG, "2***"+String.valueOf(allActivities2.size()));
    ...
    private class LoadTotalEarnedMoney extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            post.add(new BasicNameValuePair("m_email",Info.userId));
            ...
            try {
                ...
                deepSleepTime = (int)(Math.random()*91)+30;
